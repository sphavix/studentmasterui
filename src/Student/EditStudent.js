...
class Edit extends React.Component {  
  ...
  componentDidMount() {  
      axios.get('https://localhost:44388/api/Students/AddOrUpdateStudent/GetStudentById?id='+this.props.match.params.id)  
          .then(response => {  
              this.setState({   
  ...
  onSubmit(e) {  
    ...
    axios.post('https://localhost:44388/api/Students/AddOrUpdateStudent/', obj)  
